...
namespace POD.Wizards.Steps.HitMissNormalSteps
{
    public partial class QuickRegressionBar : WizardActionBar
    {
        ...
        public QuickRegressionBar(PODToolTip tooltip) : base(tooltip)
        {
            ...
            _hideTable = new PODBooleanButton("Show Data Table", "Hide Data Table", true, "Show or hide data input table. (Ctrl + D)", StepToolTip);
           ...
           // _cycleButton = new PODButton("&Cycle Transforms", "Cycle through log and linear combinations. (Alt + C)", PODStepToolTip);
