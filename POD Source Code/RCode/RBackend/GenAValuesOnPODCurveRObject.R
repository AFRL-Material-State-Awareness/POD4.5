...
GenAValuesOnPODCurve <- setRefClass("GenAValuesOnPODCurve", 
                                              ...
                                              calcAValuesModWald=function(){
                                                ...
                                                #print(probsAt95CI)
                                                #is it okay to predict values again? ASK CHRISTIE
