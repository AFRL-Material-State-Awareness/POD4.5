...
HMLogitApproximation <- setRefClass("HMLogitApproximation", fields = list(inputDataFrameLogistic="data.frame", logitResults="glm", separated="numeric"), methods = list(
                                                                        ...
                                                                        calcLogitResults=function(){
                                                                          ...
                                                                          LReg_test.mod<-try(glm(formula = y ~ x, data=inputDataFrameLogistic, family=binomial), FALSE)
