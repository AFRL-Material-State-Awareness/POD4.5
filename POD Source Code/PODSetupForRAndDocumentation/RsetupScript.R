...
install_version('pillar', version = '1.8.0', repos = 'http://cran.us.r-project.org')  
...
install_version('ggplot2', version = '3.3.4', repos = 'http://cran.us.r-project.org')  
...
install_version('nloptr', version =  '2.0.3', repos = 'http://cran.us.r-project.org') ##Will ask if you wanna update
install_version('quantreg', version =  '5.94', repos = 'http://cran.us.r-project.org')
install_version('lme4', version =  '1.1-30', repos = 'http://cran.us.r-project.org') ##Will ask if you wanna update
install_version('car', version =  '3.1-0', repos = 'http://cran.us.r-project.org') ##Will ask if you wanna update
...
install_version('roxygen2', version =  '7.1.2', repos = 'http://cran.us.r-project.org')
