    ...
    public partial class DockPane : UserControl, IDockDragSource
    {
        ...
        public virtual IDockContent ActiveContent
        {
            ...
            set
            {
                ...
                if(oldValue != null)
                    oldValue.SuspendDrawing();

                if(m_activeContent != null)
                    m_activeContent.SuspendDrawing();
                ...
                if (oldValue != null)
                    oldValue.ResumeDrawing();

                if (m_activeContent != null)
                    m_activeContent.ResumeDrawing();
            }
        }
